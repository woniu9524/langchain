...
| Text Embedding | 将字符串嵌入到向量中 | [embed](https://docs.cohere.com/reference/embed) | `from langchain_cohere import CohereEmbeddings` | [cohere.ipynb](/docs/integrations/text_embedding/cohere) |
...
Cohere [聊天模型](/docs/integrations/chat/cohere) 的用法
...
print(res.content)
```
如上所示，可以通过将必要的工具绑定到 LLM 来使用 Cohere LLM 进行工具调用。
