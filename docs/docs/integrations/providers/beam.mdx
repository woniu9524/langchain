...
>[Beam](https://www.beam.cloud/) 是一个云计算平台，允许您在带有 GPU 的远程服务器上运行代码。
...
请参阅 [使用示例](/docs/integrations/llms/beam)。

请参阅 [Beam 文档](https://docs.beam.cloud/examples/langchain) 中的另一个示例。
