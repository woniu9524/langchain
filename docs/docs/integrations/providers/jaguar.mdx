...
本页面介绍如何在 LangChain 中使用 Jaguar 向量数据库。
它包含三个部分：简介、安装与设置以及 Jaguar API。
...
8. 距离度量：欧几里得距离、余弦相似度、内积、曼哈顿距离、切比雪夫距离、汉明距离、杰卡德距离、闵可夫斯基距离
...
与 LangChain 结合使用时，可以通过在 Python 中导入来使用 Jaguar 客户端类：
